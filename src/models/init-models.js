...
function initModels(sequelize) {
  ...
  attendance.belongsTo(shifts, { as: "shift", foreignKey: "shift_id"});
  shifts.hasMany(attendance, { as: "attendances", foreignKey: "shift_id"});
  ...
  attendance.belongsTo(user_db, { as: "user", foreignKey: "user_id"});
  user_db.hasMany(attendance, { as: "attendances", foreignKey: "user_id"});
  ...
  shifts.belongsTo(user_db, { as: "user", foreignKey: "user_id"});
  user_db.hasMany(shifts, { as: "shifts", foreignKey: "user_id"});
